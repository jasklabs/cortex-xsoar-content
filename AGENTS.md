...
## Commands
- Build: <!-- TODO: what is the build command for this repo? -->
- Test: `npm test`
...
## Testing
- <!-- TODO: what testing framework is used? Any special setup required? -->

## Git workflow
- Branch naming: Jira ticket prefix (e.g., SUMO-XXXXX/description)
- <!-- TODO: any specific PR/review conventions for this repo? -->

## Gotchas / context
- <!-- TODO: what non-obvious things would trip up an agent working in this repo? -->
